...
export default function VerDatos({ setModalDishes }) {
  ...
  const datosUbicacion = {
    ...
    link:
      "https://www.google.com/maps/place/UADE/@-34.6173554,-58.3817769,15z/data=!4m2!3m1!1s0x0:0x1a2dc24cbca665a7?sa=X&ved=2ahUKEwieueHOr9vlAhVGGbkGHT4ZAxgQ_BIwCnoECA0QCA",
  };
  ...
  return (
    <div className={estilos.mainFrame}>
      ...
      <a href={datosUbicacion.link}>
        <img
          src={require(`../images/ubicacionResto.png`)}
          to={datosUbicacion.link}
          height="321"
          width="510"
          alt=""
        ></img>
      ...
      <div className={estilos.dataFrame}>
        <div style={{ display: "flex", marginTop: "5px" }}>
          <img
            src={require(`../images/icon/phone.png`)}
            height="25"
            width="25"
            alt=""
          ></img>
          <Typography style={{ marginLeft: "5px" }} variant="subtitle2">
            {datosUbicacion.telefono}
          </Typography>
        </div>
        <div style={{ display: "flex", marginTop: "5px" }}>
          <img
            src={require(`../images/icon/time.png`)}
            height="25"
            width="25"
            alt=""
          ></img>
          <Typography style={{ marginLeft: "5px" }} variant="subtitle2">
            {datosUbicacion.horario}{" "}
          </Typography>
        </div>
        <div style={{ display: "flex", marginTop: "5px" }}>
          <img
          ...
          ></img>
          <Typography style={{ marginLeft: "5px" }} variant="subtitle2">
            {datosUbicacion.email}{" "}
          </Typography>
        </div>
        <div style={{ display: "flex", marginTop: "5px" }}>
          <img
            src={require(`../images/icon/website.png`)}
            height="25"
            width="25"
            alt=""
          ></img>
          <Typography style={{ marginLeft: "5px" }} variant="subtitle2">
            {datosUbicacion.website}{" "}
          </Typography>
        </div>
      </div>
      <div
