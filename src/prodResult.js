    ...
    return (
        <div className={estilos.app}>
            ...
            <div className={estilos.subtitulo}>
                <Typography className={fuentesEstilos.ubicacion} variant="subtitle1" component="h4">
                    Ubicado en {ubicacion}
                </Typography>
                <div className={estilos.calificacionEstrellas}>
                    <img height="26" width="125" src={require(`./images/stars/${imagenRanking}`)} alt=''></img>
                </div>
            </div>

            {/* Marco que almacena Foto, Descripción y Mapa */}
            <div className={estilos.secondFrame}>

                <div className={estilos.marcoImagen}>
                    <img height="250" width="400" src={require(`./images/${imagenPlato}`)} alt=''></img>
                    <div className={estilos.precio}>
                        <Typography variant="h5" component="h2">Precio: </Typography>
                        <Box style={{ color: "#152EE4" }} fontWeight="fontWeightBold" fontSize={34} m={0}>
                            ${precio}
                        </Box>
                    </div>
                </div>
                ...
                <div className={estilos.marcoDescriMapa}>
                    <div className={estilos.marcoDescripcion}>
                        <Typography style={{ paddingLeft: "10px" }} variant="h5" component="h2">
                            Descripción del Plato
                        </Typography>
                        {descripcion.map((desc) =>
                            <Typography style={{ marginTop: '-50px', paddingLeft: "10px" }} variant="body2" component="h2">
                                {desc}
                            </Typography>
                    ...
                    <div className={estilos.marcoMapa}>
                        ...
                        <img style={{ paddingLeft: "15%" }} width="250" height="219" src={require(`./images/${imagenUbicacion}`)} alt=''></img>
                    </div>

                </div>

            </div>
            <div style={{ display: 'flex', flexWrap: 'wrap', }} width="300px" heigth="100px">
                <div style={{ position: "relative", width: "400px" }}>
                </div>
                <div className={estilos.marcoBotones}>
                    <Button variant="contained" color="primary" className={btnestilo.button}>
                        Hacer Pedido
                    </Button>
                    <Button variant="contained" color="primary" className={btnestilo.button}>
                        Reservar Mesa
            ...
            <div className={estilos.marcoCalificaciones}>
                <Typography style={{ paddingLeft: "10px" }} component="h2" variant="h6">Calificaciones</Typography>
            ...
            <div className={estilos.marcoReviews}>Opiniones
